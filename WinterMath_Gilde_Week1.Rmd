...
+ Step 1. Find $$€–lim€—”¬(€–x†’1€—^- )”œ  f (x)”¤ $$. **2**

+ Step 2. Find $$€–lim€—”¬(€–x†’1€—^+ )”œ  f (x)”¤$$.  **-5**

+ Step 3. Find $$€–lim€—”¬(x†’1)”œ  f (x)”¤$$. **Does not exist**
...
#### 6. 	Find the derivative for the following function. g(x)  = 5âˆ›x
```{r}
...
####13. 	After a sewage spill, the level of pollution in Sootville is estimated by  f (t)  =  (550t^2)/âˆš( &t^2  + 15), where t  is the time in days since the spill occurred.  How fast is the level changing after 3  days?  Round to the nearest whole number. 
```{r #13}
...
####32. 	Use integration by parts to evaluate the definite integral below. âˆ«_(-7)^2â–’â”œ xâˆš( &x + 7) dxâ”¤ Write your answer as a fraction.
```{r 32}
